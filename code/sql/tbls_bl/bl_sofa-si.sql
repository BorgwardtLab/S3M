...
DROP MATERIALIZED VIEW IF EXISTS bl_SOFA_si; -- bl_ CHANGE !

CREATE MATERIALIZED VIEW bl_SOFA_si AS   -- bl_ CHANGE !
with vaso_mv as
(
  ...
  inner join inputevents_mv mv
    ...
    and mv.starttime
    between (s.si_starttime - interval '72' hour) -- bl_ CHANGE, cave: here they use s.si_starttime! not ie. !
        and s.si_starttime     
